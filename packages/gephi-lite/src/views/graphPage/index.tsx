...
import { type ComponentType, FC, useEffect, useRef, useState } from "react";
...
import { Graph3D } from "@gephi/vrephi";
import { IGraph3D } from "@gephi/vrephi/src/components/core/Graph3D";
...
export const GraphPage: FC = () => {
  ...
  const startVrRef = useRef<IGraph3D>(null);
  ...
  return (
    <>
      <Header startVR={startVrRef?.current?.loadData}>
