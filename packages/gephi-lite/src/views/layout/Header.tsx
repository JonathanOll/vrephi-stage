...
import { StartVrButton } from "@gephi/vrephi";

export const Header: FC<{children?: ReactNode | undefined, startVR?: () => void}> = ({ children, startVR }) => {
      ...
      <section className="row gx-0">
        ...
        <section className="col-2 col-sm-4 d-flex justify-content-end align-items-center">
          ...
          <div className="d-none d-sm-flex">
            {startVR && <StartVrButton start={startVR}/>}
            <ThemeSwitcher />
            <LocalSwitcher />
